...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4">
      ...
      <div className="fixed top-[-10%] right-[-10%] w-[40%] h-[40%] bg-white/5 rounded-full blur-[120px] pointer-events-none" />
      <div className="fixed bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-white/5 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="bg-grey/80 backdrop-blur-xl p-10 rounded-3xl shadow-2xl border border-white/10 flex flex-col gap-8">
          ...
          >
            ...
            <span className="text-lg font-semibold">
              {isRegistering ? "Creating..." : "Sign up with Google"}
            </span>
            {isRegistering && (
